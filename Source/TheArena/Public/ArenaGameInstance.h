...
class FArenaPendingInvite
{
public:
	FArenaPendingInvite() : ControllerId(-1), bPrivilegesCheckedAndAllowed(false) {}
...
private:
	...
	FArenaPendingInvite PendingInvite;
