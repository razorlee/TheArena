...
#include "TheArena.h"
#include "ArenaCoverEdgeLt.h"

AArenaCoverEdgeLt::AArenaCoverEdgeLt(const class FObjectInitializer& PCIP)
	: Super(PCIP)
{
...
void AArenaCoverEdgeLt::TriggerEnter(class AActor* OtherActor)
{

}

void AArenaCoverEdgeLt::TriggerExit(class AActor* OtherActor)
{
