...
#include "TheArena.h"
#include "ArenaExplosionEffect.h"

AArenaExplosionEffect::AArenaExplosionEffect(const class FObjectInitializer& PCIP) 
	: Super(PCIP)
{
...
void AArenaExplosionEffect::BeginPlay()
{
	Super::BeginPlay();
...
void AArenaExplosionEffect::Tick(float DeltaSeconds)
{
